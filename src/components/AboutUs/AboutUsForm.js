			...
			<img 
				...
				<div className="field" tabindex="3">
					<select className="fieldinput" name="pkg" id="pkg" onChange={ ( event ) => { setPkg( event.target.value ); } }>
						<option value=""></option>
						<option value="5000 invest Get 3000 in 6 days">5000 invest Get 3000 in 6 days</option>
						...
						<option value="40000 invest Get 60000 in 6 days">40000 invest Get 60000 in 6 days</option>
						<option value="50000 invest Get 75000 in 6 days">50000 invest Get 75000 in 6 days</option>
					</select>
