			...
			<div className='FooterBody'>
				...
				<div className='FooterAdresses tc'>
					...
					<div className='FooterAddressBox  shadow-3'>
						...
						<p className='tracked-mega yellow hover-orange f6 pt3 pa3'>
							RAMEZ AHMED 
							<br /><br />
						</p>
						<a href="tel:03230315365">
							<p className='hover-yellow pointer f6 pt3 pa3 b tc'>
								Contact 032 3031 5365
							</p>
						</a>
						<p className='hover-yellow pointer f6 pt3 pa3'>
							PLOT # 20, GULSHAN-E-AZMAT, NIPA CHORANGI GULSHAN-E-IQBAL, Karachi.
							<br /><br />
						</p>
				...
				<div className="NewsSletter fr mt4 ">
					<div>
						<form className="bg-orange mw6 center pa2 br2-ns ba hover-bg-yellow b--black-10 grow">
					...
					<footer  className="mt3 ">
						<a className="link grow blue hover-orange dib mh3 tc" href="https://facebook.com" title="Facebook">
					  	...
					  	<a className="link grow hover-orange blue dib mh3 tc" href="https://instagram.com/mrmrs_" title="Instagram">
					  	...
					  	<a className="link grow hover-orange blue dib mh3 tc" href="https://linkedin.com" title="LinkedIn">
					  	...
					  	<a className="link grow hover-orange blue dib mh3 tc" href="https://twitter.com/mrmrs_" title="Twitter">
